...
public class MQTTExceptionListenerTest {
    @Test
    public void logMessageOnException() throws JMSException {
        Logger logger = mock(Logger.class);
        MQTTExceptionListener listener = new MQTTExceptionListener(logger, true);
    ...
    public void throwException() throws JMSException {
        Logger logger = mock(Logger.class);
        MQTTExceptionListener listener = new MQTTExceptionListener(logger, false);
